package {
	...
	public class Table extends Acteur {
		...
		public function Table(nom:String, x2D:Number, y2D:Number, angleAbsolu:Number, dimension:Number, couleurPlateau:uint, couleurContour:uint, couleurPieds:uint,nbPieds:Number) {			
			...
			trace("construction de la table en x:"+x2D+",y:"+y2D+",angleabs:"+angleAbsolu);
...
/* 			trace("AvG2D:"+coinAvG_x2D+","+coinAvG_y2D);
			trace("AvD2D:"+coinAvD_x2D+","+coinAvD_y2D);
			trace("ArrG2D:"+coinArrG_x2D+","+coinArrG_y2D);			
			trace("ArrD2D:"+coinArrD_x2D+","+coinArrD_y2D);	 */		
		}
		...
		********************************/
		...
		public function calculAngleVue( coinX:Number , coinY:Number , proprioX2D:Number, proprioY2D:Number, distance:Number ) :  Number {
			...
			trace("----distance:"+distance+"\n----temp:"+temp+"\n----temp/distance:"+(temp/distance)+
				  "\n----Math.acos(temp/distance)"+Math.acos(temp/distance)+"\n");
			return angle;
		...
		public override function CalculCoordonnee3D(persProprio:Personne):void {
			...
			trace("AvG3D:"+coinAvG_x3D+","+coinAvG_y3D);
			trace("AvD3D:"+coinAvD_x3D+","+coinAvD_y3D);
			trace("ArrG3D:"+coinArrG_x3D+","+coinArrG_y3D);			
			trace("ArrD3D:"+coinArrD_x3D+","+coinArrD_y3D);	
		}
