package test{
	...
	public class afficherMessage{
		...
		//fonction renvoyant un code hexadecimal suivant le nom d'une couleur
		public function couleur(couleur:String):Object
		{
			var code:Object
		...
		public function donneTaille (diag:Number):Number
		{
			var taille:Number;
		...
		public function MessageAfficher (msg:String,pt1:Point,pt2:Point,pt3:Point,pt4:Point):Sprite {
			...
			var taille:Number = donneTaille(diag);
			format.font = "Verdana";
