 package
{
	...
	public class Avatar
	{
		...
		private function loadXMLcompleted(event:Event)
		{
			...
			{
				if (typeTemp != Avatar.@typeAvatar)
					{
						tabPhoto[Avatar.@typeAvatar] = new Array();
						typeTemp = Avatar.@typeAvatar;
					}
		...
		public static function getZoneTexte(type:String,stature:String,orientation:String):Array
		{
			...
			ZoneTexte[0] = - 235/2 + tabPhoto[type][stature][orientation]["zonetexte"]["x1"];
			ZoneTexte[1] = - 375 + tabPhoto[type][stature][orientation]["zonetexte"]["y1"];
			ZoneTexte[2] = - 375 + tabPhoto[type][stature][orientation]["zonetexte"]["y2"];
			ZoneTexte[3] = - 235/2 + tabPhoto[type][stature][orientation]["zonetexte"]["x2"];
			return ZoneTexte;
		}
